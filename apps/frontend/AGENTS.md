...
- [`docs/architecture.md`](docs/architecture.md) — 워크스페이스 구조, 패키지 구조, FSD-lite 레이어, 의존 방향, 서버/클라이언트 경계, 시크릿 경계, 설정 불변식, 빌드가 강제하는 불변식
...
- 한 불릿은 한 문장으로 쓴다. 나눌 수 있는 규칙은 불릿을 나눈다.
