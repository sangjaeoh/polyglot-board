package com.board.app.api.facade;

import com.board.domain.board.application.info.PostInfo;
import com.board.domain.board.application.provided.PostAppender;
import com.board.domain.board.application.provided.PostModifier;
